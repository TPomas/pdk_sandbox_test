...
def setup_config(config_file, repo, pipeline, job_id, project):
    ...
    HTTP_PROXY_str = "HTTP_PROXY=" + str(os.getenv("HTTP_PROXY"))
    HTTPS_PROXY_str = "HTTPS_PROXY=" + str(os.getenv("HTTPS_PROXY"))
    http_proxy_str = "http_proxy=" + str(os.getenv("http_proxy"))
    https_proxy_str = "https_proxy=" + str(os.getenv("https_proxy"))
    no_proxy_str = "no_proxy=" + str(os.getenv("no_proxy"))
    
    config["environment"]["environment_variables"].append(HTTP_PROXY_str)
    config["environment"]["environment_variables"].append(HTTPS_PROXY_str)
    config["environment"]["environment_variables"].append(http_proxy_str)
    config["environment"]["environment_variables"].append(https_proxy_str)
    config["environment"]["environment_variables"].append(no_proxy_str)
...
def main():
    ...
    os.environ["HTTP_PROXY"] = os.getenv("prox")
    os.environ["HTTPS_PROXY"] = os.getenv("prox")
    os.environ["http_proxy"] = os.getenv("prox")
    os.environ["https_proxy"] = os.getenv("prox")
    os.environ["no_proxy"] = os.getenv("noprox")
